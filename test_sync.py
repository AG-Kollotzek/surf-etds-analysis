...
def main():
    ...
    csv_full_path = data_dir / "csv" / "ETD_QA_PoP_SingleCouchOrientation_20260310_160448.csv"
    json_full_path = data_dir / "01_json" / "TrackingResult_2026-03-10_16-06-17.json"
